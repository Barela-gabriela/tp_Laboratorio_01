...
{
    int option;
    printf("\t ******MENU DE OPERACIONES******\n -----------------------------------------------------------------------------\n| 1 .CARGAR LOS DATOS DE LOS EMPLEADOS DESDE EL ARCHIVO DATA.CVS(MODO TEXTO)  |\n| 2 .CARGAR LOS DATOS DE LOS EMPLEADOS DESDE EL ARCHIVO DATA.BIN(MODO BINARIO)|\n| 3 .ALTA DE EMPLEADOS                                                        |\n| 4 .MODIFICAR DATOS DE EMPLEADO                                              |\n| 5 .BAJA DE EMPLEADO                                                         |\n| 6 .LISTAR EMPLEADOS                                                         |\n| 7 .OREDENAR EMPLEADOS                                                       |\n| 8 .GUARDAR LOS DATOS DE LOS EMPLEADOS EN EL ARCHIVO DATA.CVS(MODO TEXTO)    |\n| 9 .GUARDAR LOS DATOS DE LOS EMPLEADOS EN EL ARCHIVO DATA.BIN(MODO BINARIO)  |\n| 10.SALIR                                                                    |\n -----------------------------------------------------------------------------\n\nElija una opcion: ");
    fflush(stdin);
    scanf("%d",&option);
    return option;
}
